...
// Public client identifiers for the CivicX Firebase project — safe to
...
const firebaseConfig = {
  ...
  authDomain: "civicx-94786.firebaseapp.com",
  projectId: "civicx-94786",
  storageBucket: "civicx-94786.firebasestorage.app",
